...
class RangeCalendarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        calendarView.setRangeBackgroundColor(Color.parseColor("#50000000"))
        ...
        calendarView.setOnDateChangeListener(object : CalendarView.OnDateChangeListener {
            override fun onSelectedDateChange(view: CalendarView, selectedDate: List<String>) {
                Toast.makeText(this@RangeCalendarActivity, "已选：${selectedDate.size}天", Toast.LENGTH_SHORT).show()
            }
